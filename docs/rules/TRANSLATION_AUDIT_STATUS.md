...
2. Une question de règle reste à trancher pour le Tromblon Nain du Chaos (40 CO, règles propres — substitution déjà délibérée dans le code, mais dont la source citée "FH" reste introuvable ; les seules sources disponibles, Nains du Chaos [GLM].pdf et Black Dwarfs.pdf, ne décrivent qu'un Tromblon générique à 30 CO) : Yannick va fournir le PDF source qui la justifie, ne rien changer avant réception. L'accès du Franc-Tireur Sorcière pour les Nains du Chaos, en revanche, est tranché — voir `PROJECT_DECISIONS.md`.
