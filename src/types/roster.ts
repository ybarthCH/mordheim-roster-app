...
export type Member = {
  ...
  // Superposé par resolveProfil sur le profil animal de base (grille XP/
  // table d'avancement/gagne_experience forcés sur Homme de Main) SANS
  // changer `type`, qui reste 'animal' — un changement de type aurait aussi
  // débloqué à tort l'achat d'équipement (voir profilPeutAcheterEquipement).
  // Le profil de base porte lui-même `ne_peut_jamais_devenir_heros` pour
  // bloquer "Ce gars est doué".
