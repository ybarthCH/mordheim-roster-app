...
export const rechercheReference: UiDictionary = {
  ...
  'rechercheReference.tooMany': {
    fr: "D'autres résultats existent — affinez votre recherche.",
  ...
  'rechercheReference.section.regleSpeciale': { fr: 'Règles spéciales', en: 'Special rules' },
  'rechercheReference.section.sort': { fr: 'Magie', en: 'Magic' },
};
