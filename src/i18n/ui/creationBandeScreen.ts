...
export const creationBandeScreen: UiDictionary = {
  ...
  'creation.hero': { fr: 'Héros', en: 'Hero' },
  'creation.henchman': { fr: 'Homme de main', en: 'Henchman' },
  'creation.unique': { fr: 'Unique', en: 'Unique' },
  'creation.max': { fr: 'Max', en: 'Max' },
  'creation.costUnknown': { fr: 'coût ?', en: 'cost ?' },
  'creation.gc': { fr: 'po', en: 'gc' },
  'creation.add': { fr: '+ Ajouter', en: '+ Add' },
  ...
  'creation.modal.figurineCount': { fr: 'Nombre de figurines (groupe identique)', en: 'Number of models (identical group)' },
  ...
  'creation.modal.remaining': { fr: 'po restantes,', en: 'gc remaining,' },
  'creation.modal.required': { fr: 'po requis).', en: 'gc required).' },
  'creation.modal.cancel': { fr: 'Annuler', en: 'Cancel' },
  'creation.modal.addFor': { fr: 'Ajouter pour', en: 'Add for' },
